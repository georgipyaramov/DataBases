...
namespace EntityFramework.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> GetSuppIncome(string supplierName, Nullable<int> startYear, Nullable<int> endYear)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("GetSuppIncome", supplierNameParameter, startYearParameter, endYearParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> GetSupplierIncome(string supplierName, Nullable<int> startYear, Nullable<int> endYear)
        {
            var supplierNameParameter = supplierName != null ?
                new ObjectParameter("supplierName", supplierName) :
                new ObjectParameter("supplierName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("GetSupplierIncome", supplierNameParameter, startYearParameter, endYearParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_GetSupplierIncome(string supplierName, Nullable<int> startYear, Nullable<int> endYear)
        {
            var supplierNameParameter = supplierName != null ?
                new ObjectParameter("supplierName", supplierName) :
                new ObjectParameter("supplierName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_GetSupplierIncome", supplierNameParameter, startYearParameter, endYearParameter);
        }
    }
}
